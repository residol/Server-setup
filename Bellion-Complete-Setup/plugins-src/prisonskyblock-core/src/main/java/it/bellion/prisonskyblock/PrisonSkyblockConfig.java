...
public class PrisonSkyblockConfig {
    private final JavaPlugin plugin;
    private FileConfiguration config;

    public PrisonSkyblockConfig(JavaPlugin plugin) {
        this.plugin = plugin;
    ...
    public boolean isDualProgressEnabled() {
        return config.getBoolean("dual_progress.enabled", true);
    }
